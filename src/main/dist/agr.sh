...
$RUNLOAD -object:gene -species:RAT -mapKey:380 -mapKey2:381 -toDir:$LOGDIR/AGR/ -chr:* -flavor:AGR -compress  &> cron_ratAGR.log
mailx -s "[$SERVER]Pipeline to create AGR Gff3 data for Rat Gene assembly GRCr8 ran" $EMAILLIST<cron_ratAGR.log
