...
# GRCr8 samples
LOGFILE=cron_ratcn8.log
rm $LOGFILE
$RUNLOAD -patientID:380 -source:CN -toFile:$OUTDIR/rat8/ -chr:$CHR_RAT -compress  2>&1 | tee -a $LOGFILE
mailx -s "[$SERVER]Pipeline to create Gff3 data for ratcn 8 ran" $EMAILLIST<$LOGFILE
