...
$RUNLOAD -object:biologicalRegions > biological_regions.log
...
mkdir -p "data/jbrowse2/Rat/UTH_Rnor_SHRSP_BbbUtx_1.0/Gene Models"
...
mkdir -p "data/jbrowse2/Rat/UTH_Rnor_WKY_Bbb_1.0/Gene Models"
